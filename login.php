          ...
          <div class="card-body">
            ...
            <form class="form-signin" method="POST" action="login.php">
              ...
              <div class="form-label-group">
                <input type="email" onfocus="this.value=''" class="form-control" placeholder="Email" name="email">
                 <?php echo isset($error['email']) ? $error['email']: ""  ?>
              </div>
              
              <label for="inputPassword">Mật khẩu</label>
              <div class="form-label-group">
                <input type="password"  onfocus="this.value=''" class="form-control" placeholder="Password" name="password">
